...
class ContextAnalyzer:
    ...
    def _find_entrypoints(self) -> Dict[str, any]:
        ...
        has_routes = (
            self._directory_exists('routes') or
            self._directory_exists('api') or
            self._directory_exists('handlers')
        )
    ...
    def _detect_security_controls(self) -> Dict[str, any]:
        ...
        security_configs = [
            '.semgrep.yml', '.bandit', 'bandit.yaml',
            '.snyk', 'sonar-project.properties'
        ]
